      ...
      <div className="relative overflow-hidden border-b-2 border-border">
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-24 lg:py-32">
          ...
          <p className="text-xl lg:text-2xl text-muted-foreground max-w-2xl mb-12 animate-fade-in leading-relaxed">
            Simple, fast, and reliable API solutions for modern developers. 
            Build faster with our minimalist approach to integration.
          </p>
          ...
          <div className="grid grid-cols-3 gap-8 mt-20 pt-12 border-t-2 border-border animate-fade-in" style={{ animationDelay: '0.4s' }}>
            <div>
              ...
              <div className="text-sm font-mono text-muted-foreground uppercase tracking-wider">APIs Available</div>
            </div>
            <div>
              <div className="text-4xl lg:text-5xl font-display mb-2">99.9%</div>
              <div className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Uptime</div>
            </div>
            <div>
              <div className="text-4xl lg:text-5xl font-display mb-2">&lt;100ms</div>
              <div className="text-sm font-mono text-muted-foreground uppercase tracking-wider">Avg Response</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="apis" className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        <div className="mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Choose the right API for your needs. Each one is designed for performance and simplicity.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
            <div>
              ...
              <p className="text-sm font-mono text-muted-foreground">Building the future of APIs</p>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-border text-center">
            <p className="text-xs font-mono text-muted-foreground uppercase tracking-wider">
              © 2024 MateuSolutions. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
